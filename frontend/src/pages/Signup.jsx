  ...
  return(
    <div className='flex justify-center items-center min-h-screen bg-pink-100'>
      ...
      <CardContent>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid gap-2">
             ...
             <Input id="password" name= "password" placeholder="Create a password" value={formData.password} onChange={handleChange}
      ...
      <CardFooter className="flex-col gap-2">
        ...
        <p className='text-gray-700 text-sm'>Already have an account ? <Link to={'/login'} className='hover:underline cursor-pointer text-pink-800'>Link</Link></p>
      </CardFooter>
    </Card>
    </div>
  )
