    ...
    <div className='pt-20 bg-gray-50 min-h-screen'>
      {
        cart?.items?.length > 0 ? <div className='max-w-7xl mx-auto'>
                ...
                return <Card key={index}>
                  <div className='flex justify-between items-center pr-7'>
                    ...
                    <div className='flex gap-5 items-center'>
                     ...
                     <p onClick ={()=>handleRemove(product.productId._id)} className='flex text-red-500 items-center gap-1 cursor-pointer'><Trash2 className='w-4'/>Remove </p>
                  </div>
                </Card>
              })}
            </div>
          ...
          <p className='mt-2 text-gray-600'>Looke like you haven't anything to ypur cart yet </p>
          <Button onClick ={()=>navigate('/products')}   className='mt-6 bg-pink-600 text-white py-3 px-6 cursor-pointer hover:bg-pink-700'>Start Shopping</Button>
