    ...
    <footer className='bg-gray-900 text-gray-200 py-10'>
        <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
            ...
            <div className='mb-6 md:mb-0'>
                <Link to='/'><img src="/cart.png" alt=""  className='w-20'/></Link>
            ...
            <div>
                ...
                <form action="" className='mt-4 flex'>
                    <input type="email" placeholder='Your email address' className='w-full p-2 rounded-1-md bg-white text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500' />
